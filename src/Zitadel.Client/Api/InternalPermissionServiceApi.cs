...
public class InternalPermissionServiceApi : BaseApi
{
    ...
    public async Task<InternalPermissionServiceCreateAdministratorResponse> CreateAdministratorAsync(
        InternalPermissionServiceCreateAdministratorRequest internalPermissionServiceCreateAdministratorRequest
    )
    {
        Task<ApiResult<InternalPermissionServiceCreateAdministratorResponse>> task =
            CreateAdministratorWithHttpInfoAsync(
                internalPermissionServiceCreateAdministratorRequest
            );
        ApiResult<InternalPermissionServiceCreateAdministratorResponse> result =
    ...
    /// <exception cref="ApiException">Thrown when the API call fails.</exception>
    public async Task<InternalPermissionServiceDeleteAdministratorResponse> DeleteAdministratorAsync(
        InternalPermissionServiceDeleteAdministratorRequest internalPermissionServiceDeleteAdministratorRequest
    )
    {
        Task<ApiResult<InternalPermissionServiceDeleteAdministratorResponse>> task =
            DeleteAdministratorWithHttpInfoAsync(
                internalPermissionServiceDeleteAdministratorRequest
            );
        ApiResult<InternalPermissionServiceDeleteAdministratorResponse> result =
            await task.ConfigureAwait(false);
        /* convenience-empty-body-handling: a body-returning operation that
         * receives no decodable body surfaces the same typed, catchable
         * ApiException as any other API failure (carrying the status code,
    ...
    /// <exception cref="ApiException">Thrown when the API call fails.</exception>
    public async Task<InternalPermissionServiceListAdministratorsResponse> ListAdministratorsAsync(
        InternalPermissionServiceListAdministratorsRequest internalPermissionServiceListAdministratorsRequest
    )
    {
        Task<ApiResult<InternalPermissionServiceListAdministratorsResponse>> task =
            ListAdministratorsWithHttpInfoAsync(internalPermissionServiceListAdministratorsRequest);
        ApiResult<InternalPermissionServiceListAdministratorsResponse> result =
            await task.ConfigureAwait(false);
        /* convenience-empty-body-handling: a body-returning operation that
         * receives no decodable body surfaces the same typed, catchable
         * ApiException as any other API failure (carrying the status code,
    ...
    /// <exception cref="ApiException">Thrown when the API call fails.</exception>
    public async Task<InternalPermissionServiceUpdateAdministratorResponse> UpdateAdministratorAsync(
        InternalPermissionServiceUpdateAdministratorRequest internalPermissionServiceUpdateAdministratorRequest
    )
    {
        Task<ApiResult<InternalPermissionServiceUpdateAdministratorResponse>> task =
            UpdateAdministratorWithHttpInfoAsync(
                internalPermissionServiceUpdateAdministratorRequest
            );
        ApiResult<InternalPermissionServiceUpdateAdministratorResponse> result =
            await task.ConfigureAwait(false);
        /* convenience-empty-body-handling: a body-returning operation that
         * receives no decodable body surfaces the same typed, catchable
         * ApiException as any other API failure (carrying the status code,
