...
/// </summary>
public class AuthorizationServiceConnectError : IEquatable<AuthorizationServiceConnectError>
{
    ...
    public List<AuthorizationServiceAny>? Details { get; set; }
    ...
    public bool Equals(AuthorizationServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as AuthorizationServiceConnectError);
    }
