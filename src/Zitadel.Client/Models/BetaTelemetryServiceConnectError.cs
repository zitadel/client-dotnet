...
/// </summary>
public class BetaTelemetryServiceConnectError : IEquatable<BetaTelemetryServiceConnectError>
{
    ...
    public List<BetaTelemetryServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaTelemetryServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaTelemetryServiceConnectError);
    }
