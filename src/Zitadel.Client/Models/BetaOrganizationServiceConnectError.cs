...
/// </summary>
public class BetaOrganizationServiceConnectError : IEquatable<BetaOrganizationServiceConnectError>
{
    ...
    public List<BetaOrganizationServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaOrganizationServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaOrganizationServiceConnectError);
    }
