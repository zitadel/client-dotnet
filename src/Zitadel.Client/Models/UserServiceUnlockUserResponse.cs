...
public class UserServiceUnlockUserResponse : IEquatable<UserServiceUnlockUserResponse>
{
    ...
    public bool Equals(UserServiceUnlockUserResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceUnlockUserResponse);
    }
