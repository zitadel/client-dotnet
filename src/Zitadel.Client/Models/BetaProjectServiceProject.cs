...
public class BetaProjectServiceProject : IEquatable<BetaProjectServiceProject>
{
    /// <summary>
    ...
    public BetaProjectServiceProjectState? State { get; set; }
    ...
    /// <example>null</example>
    [JsonPropertyName("grantedState")]
    public BetaProjectServiceGrantedProjectState? GrantedState { get; set; }

    /// <summary>Value-equality based on all declared fields.</summary>
    public bool Equals(BetaProjectServiceProject? other)
    {
        return other is not null
            && (ReferenceEquals(this, other)
                || EqualityComparer<string?>.Default.Equals(this.Id, other.Id)
                    ...
                    && EqualityComparer<BetaProjectServiceProjectState?>.Default.Equals(this.State, other.State)
                    ...
                    && EqualityComparer<BetaProjectServiceGrantedProjectState?>.Default.Equals(this.GrantedState, other.GrantedState));
    }

    public override bool Equals(object? obj)
    {
        return Equals(obj as BetaProjectServiceProject);
    }
