...
public class BetaProjectServicePaginationResponse : IEquatable<BetaProjectServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(BetaProjectServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as BetaProjectServicePaginationResponse);
    }
