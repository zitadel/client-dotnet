...
/// </summary>
public class BetaOrganizationServiceAny : IEquatable<BetaOrganizationServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaOrganizationServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaOrganizationServiceAny);
    }
