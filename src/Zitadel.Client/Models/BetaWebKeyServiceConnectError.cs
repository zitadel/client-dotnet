...
/// </summary>
public class BetaWebKeyServiceConnectError : IEquatable<BetaWebKeyServiceConnectError>
{
    ...
    public List<BetaWebKeyServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaWebKeyServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaWebKeyServiceConnectError);
    }
