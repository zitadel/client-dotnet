...
public class ApplicationServicePaginationResponse : IEquatable<ApplicationServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(ApplicationServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as ApplicationServicePaginationResponse);
    }
