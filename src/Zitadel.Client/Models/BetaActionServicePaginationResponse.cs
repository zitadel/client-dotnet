...
public class BetaActionServicePaginationResponse : IEquatable<BetaActionServicePaginationResponse>
{
    /// <summary>
    ...
    {
        return Equals(obj as BetaActionServicePaginationResponse);
    }
