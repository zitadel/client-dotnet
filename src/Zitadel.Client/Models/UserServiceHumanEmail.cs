...
public class UserServiceHumanEmail : IEquatable<UserServiceHumanEmail>
{
    ...
    public bool Equals(UserServiceHumanEmail? other)
    {
    ...
    {
        return Equals(obj as UserServiceHumanEmail);
    }
