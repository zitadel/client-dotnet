...
public class UserServiceSendEmailCodeResponse : IEquatable<UserServiceSendEmailCodeResponse>
{
    ...
    public bool Equals(UserServiceSendEmailCodeResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceSendEmailCodeResponse);
    }
