...
public class BetaInstanceServicePaginationRequest : IEquatable<BetaInstanceServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(BetaInstanceServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as BetaInstanceServicePaginationRequest);
    }
