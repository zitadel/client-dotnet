...
/// </summary>
public class BetaActionServiceConnectError : IEquatable<BetaActionServiceConnectError>
{
    ...
    public List<BetaActionServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaActionServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaActionServiceConnectError);
    }
