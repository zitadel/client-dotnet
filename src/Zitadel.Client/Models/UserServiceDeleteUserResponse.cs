...
public class UserServiceDeleteUserResponse : IEquatable<UserServiceDeleteUserResponse>
{
    ...
    public bool Equals(UserServiceDeleteUserResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceDeleteUserResponse);
    }
