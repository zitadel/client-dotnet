...
public class BetaInternalPermissionServicePaginationRequest : IEquatable<BetaInternalPermissionServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(BetaInternalPermissionServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as BetaInternalPermissionServicePaginationRequest);
    }
