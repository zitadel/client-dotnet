...
public class OrganizationServicePaginationResponse : IEquatable<OrganizationServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(OrganizationServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as OrganizationServicePaginationResponse);
    }
