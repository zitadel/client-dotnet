...
/// </summary>
public class BetaAuthorizationServiceAny : IEquatable<BetaAuthorizationServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaAuthorizationServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaAuthorizationServiceAny);
    }
