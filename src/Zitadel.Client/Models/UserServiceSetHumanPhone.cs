...
public class UserServiceSetHumanPhone : IEquatable<UserServiceSetHumanPhone>
{
    ...
    public bool Equals(UserServiceSetHumanPhone? other)
    {
    ...
    {
        return Equals(obj as UserServiceSetHumanPhone);
    }
