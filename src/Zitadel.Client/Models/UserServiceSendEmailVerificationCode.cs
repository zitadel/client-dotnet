...
public class UserServiceSendEmailVerificationCode : IEquatable<UserServiceSendEmailVerificationCode>
{
    /// <summary>
    ...
    public bool Equals(UserServiceSendEmailVerificationCode? other)
    {
    ...
    {
        return Equals(obj as UserServiceSendEmailVerificationCode);
    }
