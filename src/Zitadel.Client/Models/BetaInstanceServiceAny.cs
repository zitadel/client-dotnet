...
/// </summary>
public class BetaInstanceServiceAny : IEquatable<BetaInstanceServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaInstanceServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaInstanceServiceAny);
    }
