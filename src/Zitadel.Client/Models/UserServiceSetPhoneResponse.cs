...
public class UserServiceSetPhoneResponse : IEquatable<UserServiceSetPhoneResponse>
{
    ...
    public bool Equals(UserServiceSetPhoneResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceSetPhoneResponse);
    }
