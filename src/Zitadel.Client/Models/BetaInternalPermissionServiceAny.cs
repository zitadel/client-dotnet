...
/// </summary>
public class BetaInternalPermissionServiceAny : IEquatable<BetaInternalPermissionServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaInternalPermissionServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaInternalPermissionServiceAny);
    }
