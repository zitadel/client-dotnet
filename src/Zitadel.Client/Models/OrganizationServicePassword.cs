...
public class OrganizationServicePassword : IEquatable<OrganizationServicePassword>
{
    ...
    public bool Equals(OrganizationServicePassword? other)
    {
    ...
    {
        return Equals(obj as OrganizationServicePassword);
    }
