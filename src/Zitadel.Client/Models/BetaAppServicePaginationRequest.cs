...
public class BetaAppServicePaginationRequest : IEquatable<BetaAppServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(BetaAppServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as BetaAppServicePaginationRequest);
    }
