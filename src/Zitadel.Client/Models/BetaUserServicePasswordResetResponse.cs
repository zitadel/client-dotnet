...
public class BetaUserServicePasswordResetResponse : IEquatable<BetaUserServicePasswordResetResponse>
{
    ...
    public bool Equals(BetaUserServicePasswordResetResponse? other)
    {
    ...
    {
        return Equals(obj as BetaUserServicePasswordResetResponse);
    }
