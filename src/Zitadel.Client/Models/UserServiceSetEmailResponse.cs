...
public class UserServiceSetEmailResponse : IEquatable<UserServiceSetEmailResponse>
{
    ...
    public bool Equals(UserServiceSetEmailResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceSetEmailResponse);
    }
