...
/// </summary>
public class ApplicationServiceConnectError : IEquatable<ApplicationServiceConnectError>
{
    ...
    public List<ApplicationServiceAny>? Details { get; set; }
    ...
    public bool Equals(ApplicationServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as ApplicationServiceConnectError);
    }
