...
public class BetaUserServiceVerifyU2FRegistrationRequest
    : IEquatable<BetaUserServiceVerifyU2FRegistrationRequest>
{
    ...
    public bool Equals(BetaUserServiceVerifyU2FRegistrationRequest? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceVerifyU2FRegistrationRequest);
    }
