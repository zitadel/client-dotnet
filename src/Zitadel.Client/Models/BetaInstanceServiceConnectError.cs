...
/// </summary>
public class BetaInstanceServiceConnectError : IEquatable<BetaInstanceServiceConnectError>
{
    ...
    public List<BetaInstanceServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaInstanceServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaInstanceServiceConnectError);
    }
