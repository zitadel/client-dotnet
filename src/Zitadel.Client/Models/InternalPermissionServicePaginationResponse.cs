...
public class InternalPermissionServicePaginationResponse : IEquatable<InternalPermissionServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(InternalPermissionServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as InternalPermissionServicePaginationResponse);
    }
