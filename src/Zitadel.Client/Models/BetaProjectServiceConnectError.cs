...
/// </summary>
public class BetaProjectServiceConnectError : IEquatable<BetaProjectServiceConnectError>
{
    ...
    public List<BetaProjectServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaProjectServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaProjectServiceConnectError);
    }
