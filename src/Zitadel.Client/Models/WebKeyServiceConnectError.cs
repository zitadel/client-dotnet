...
/// </summary>
public class WebKeyServiceConnectError : IEquatable<WebKeyServiceConnectError>
{
    ...
    public List<WebKeyServiceAny>? Details { get; set; }
    ...
    public bool Equals(WebKeyServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as WebKeyServiceConnectError);
    }
