...
public class ApplicationServicePaginationRequest : IEquatable<ApplicationServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(ApplicationServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as ApplicationServicePaginationRequest);
    }
