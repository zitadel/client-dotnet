...
public class ProjectServicePaginationRequest : IEquatable<ProjectServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(ProjectServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as ProjectServicePaginationRequest);
    }
