            ...
            && (
                ...
                || EqualityComparer<bool?>.Default.Equals(
                    ...
                    && EqualityComparer<bool?>.Default.Equals(
                        ...
                        other.AllowLocalAuthentication
                    )
                    && EqualityComparer<bool?>.Default.Equals(
                        this.AllowRegister,
                        other.AllowRegister
                    ...
                    && EqualityComparer<SettingsServicePasskeysType?>.Default.Equals(
                        this.PasskeysType,
                        other.PasskeysType
                    )
                    && EqualityComparer<bool?>.Default.Equals(
                    ...
                    && EqualityComparer<List<SettingsServiceSecondFactorType>?>.Default.Equals(
                        this.SecondFactors,
                        other.SecondFactors
                    )
                    && EqualityComparer<List<SettingsServiceMultiFactorType>?>.Default.Equals(
                        this.MultiFactors,
                        other.MultiFactors
                    )
                    && EqualityComparer<bool?>.Default.Equals(
