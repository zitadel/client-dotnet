...
/// </summary>
public class SessionServiceConnectError : IEquatable<SessionServiceConnectError>
{
    ...
    public List<SessionServiceAny>? Details { get; set; }
    ...
    public bool Equals(SessionServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as SessionServiceConnectError);
    }
