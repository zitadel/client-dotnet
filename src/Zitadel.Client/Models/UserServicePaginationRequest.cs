...
public class UserServicePaginationRequest : IEquatable<UserServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(UserServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as UserServicePaginationRequest);
    }
