...
public class BetaActionServiceResponseExecution : IEquatable<BetaActionServiceResponseExecution>
{
    /// <summary>
    ...
    public bool Equals(BetaActionServiceResponseExecution? other)
    {
    ...
    {
        return Equals(obj as BetaActionServiceResponseExecution);
    }
