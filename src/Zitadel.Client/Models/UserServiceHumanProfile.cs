...
public class UserServiceHumanProfile : IEquatable<UserServiceHumanProfile>
{
    ...
    public bool Equals(UserServiceHumanProfile? other)
    {
    ...
    {
        return Equals(obj as UserServiceHumanProfile);
    }
