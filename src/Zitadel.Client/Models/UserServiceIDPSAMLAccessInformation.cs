...
public class UserServiceIDPSAMLAccessInformation : IEquatable<UserServiceIDPSAMLAccessInformation>
{
    ...
    {
        return Equals(obj as UserServiceIDPSAMLAccessInformation);
    }
