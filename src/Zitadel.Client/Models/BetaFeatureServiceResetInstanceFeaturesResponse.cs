...
public class BetaFeatureServiceResetInstanceFeaturesResponse
    : IEquatable<BetaFeatureServiceResetInstanceFeaturesResponse>
{
    ...
    public bool Equals(BetaFeatureServiceResetInstanceFeaturesResponse? other)
    {
    ...
    {
        return Equals(obj as BetaFeatureServiceResetInstanceFeaturesResponse);
    }
