...
public class ProjectServicePaginationResponse : IEquatable<ProjectServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(ProjectServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as ProjectServicePaginationResponse);
    }
