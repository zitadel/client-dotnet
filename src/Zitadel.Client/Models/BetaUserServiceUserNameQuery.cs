...
/// </summary>
public class BetaUserServiceUserNameQuery : IEquatable<BetaUserServiceUserNameQuery>
{
    ...
    public bool Equals(BetaUserServiceUserNameQuery? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceUserNameQuery);
    }
