...
/// </summary>
public class BetaFeatureServiceAny : IEquatable<BetaFeatureServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaFeatureServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaFeatureServiceAny);
    }
