...
public class UserServiceAddHumanUserResponse : IEquatable<UserServiceAddHumanUserResponse>
{
    ...
    public bool Equals(UserServiceAddHumanUserResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceAddHumanUserResponse);
    }
