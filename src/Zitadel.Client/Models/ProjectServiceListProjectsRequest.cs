...
public class ProjectServiceListProjectsRequest : IEquatable<ProjectServiceListProjectsRequest>
{
    [JsonPropertyName("pagination")]
    public ProjectServicePaginationRequest? Pagination { get; set; }

    [JsonPropertyName("sortingColumn")]
    public ProjectServiceProjectFieldName? SortingColumn { get; set; }

    /// <summary>
    /// Filters define the criteria to query for.
    /// </summary>
    [JsonPropertyName("filters")]
    public List<ProjectServiceProjectSearchFilter>? Filters { get; set; }
    ...
    {
        return Equals(obj as ProjectServiceListProjectsRequest);
    }
