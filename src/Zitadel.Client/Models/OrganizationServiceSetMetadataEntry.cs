...
public class OrganizationServiceSetMetadataEntry : IEquatable<OrganizationServiceSetMetadataEntry>
{
    ...
    {
        return Equals(obj as OrganizationServiceSetMetadataEntry);
    }
