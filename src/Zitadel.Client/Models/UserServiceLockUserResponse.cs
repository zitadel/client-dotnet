...
public class UserServiceLockUserResponse : IEquatable<UserServiceLockUserResponse>
{
    ...
    public bool Equals(UserServiceLockUserResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceLockUserResponse);
    }
