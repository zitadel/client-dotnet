...
/// </summary>
public class BetaUserServicePhoneQuery : IEquatable<BetaUserServicePhoneQuery>
{
    ...
    public bool Equals(BetaUserServicePhoneQuery? other)
    {
    ...
    {
        return Equals(obj as BetaUserServicePhoneQuery);
    }
