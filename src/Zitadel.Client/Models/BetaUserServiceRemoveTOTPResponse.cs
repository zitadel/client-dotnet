...
public class BetaUserServiceRemoveTOTPResponse : IEquatable<BetaUserServiceRemoveTOTPResponse>
{
    ...
    public bool Equals(BetaUserServiceRemoveTOTPResponse? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceRemoveTOTPResponse);
    }
