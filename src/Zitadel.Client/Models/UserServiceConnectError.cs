...
/// </summary>
public class UserServiceConnectError : IEquatable<UserServiceConnectError>
{
    ...
    public List<UserServiceAny>? Details { get; set; }
    ...
    public bool Equals(UserServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as UserServiceConnectError);
    }
