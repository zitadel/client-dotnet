...
public class InstanceServicePaginationRequest : IEquatable<InstanceServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(InstanceServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as InstanceServicePaginationRequest);
    }
