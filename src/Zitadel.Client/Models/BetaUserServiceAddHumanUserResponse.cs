...
public class BetaUserServiceAddHumanUserResponse : IEquatable<BetaUserServiceAddHumanUserResponse>
{
    ...
    {
        return Equals(obj as BetaUserServiceAddHumanUserResponse);
    }
