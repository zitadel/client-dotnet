...
public class BetaActionServicePaginationRequest : IEquatable<BetaActionServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(BetaActionServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as BetaActionServicePaginationRequest);
    }
