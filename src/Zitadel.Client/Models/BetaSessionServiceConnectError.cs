...
/// </summary>
public class BetaSessionServiceConnectError : IEquatable<BetaSessionServiceConnectError>
{
    ...
    public List<BetaSessionServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaSessionServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaSessionServiceConnectError);
    }
