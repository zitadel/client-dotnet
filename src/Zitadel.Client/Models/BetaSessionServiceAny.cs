...
/// </summary>
public class BetaSessionServiceAny : IEquatable<BetaSessionServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaSessionServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaSessionServiceAny);
    }
