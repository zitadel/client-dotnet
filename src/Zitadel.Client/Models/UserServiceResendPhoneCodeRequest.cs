...
public class UserServiceResendPhoneCodeRequest : IEquatable<UserServiceResendPhoneCodeRequest>
{
    ...
    public bool Equals(UserServiceResendPhoneCodeRequest? other)
    {
    ...
    {
        return Equals(obj as UserServiceResendPhoneCodeRequest);
    }
