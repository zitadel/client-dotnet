...
public class BetaSettingsServiceRequestContext : IEquatable<BetaSettingsServiceRequestContext>
{
    ...
    public bool Equals(BetaSettingsServiceRequestContext? other)
    {
    ...
    {
        return Equals(obj as BetaSettingsServiceRequestContext);
    }
