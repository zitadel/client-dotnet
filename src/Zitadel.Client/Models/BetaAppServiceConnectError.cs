...
/// </summary>
public class BetaAppServiceConnectError : IEquatable<BetaAppServiceConnectError>
{
    ...
    public List<BetaAppServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaAppServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaAppServiceConnectError);
    }
