...
/// </summary>
public class AuthorizationServiceAny : IEquatable<AuthorizationServiceAny>
{
    /// <summary>
    ...
    public bool Equals(AuthorizationServiceAny? other)
    {
    ...
    {
        return Equals(obj as AuthorizationServiceAny);
    }
