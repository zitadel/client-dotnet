...
/// </summary>
public class ApplicationServiceAny : IEquatable<ApplicationServiceAny>
{
    /// <summary>
    ...
    public bool Equals(ApplicationServiceAny? other)
    {
    ...
    {
        return Equals(obj as ApplicationServiceAny);
    }
