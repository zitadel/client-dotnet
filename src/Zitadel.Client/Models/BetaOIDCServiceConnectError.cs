...
/// </summary>
public class BetaOIDCServiceConnectError : IEquatable<BetaOIDCServiceConnectError>
{
    ...
    public List<BetaOIDCServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaOIDCServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaOIDCServiceConnectError);
    }
