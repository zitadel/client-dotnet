...
public class BetaUserServiceIDPLink : IEquatable<BetaUserServiceIDPLink>
{
    ...
    public bool Equals(BetaUserServiceIDPLink? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceIDPLink);
    }
