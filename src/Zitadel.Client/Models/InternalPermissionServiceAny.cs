...
/// </summary>
public class InternalPermissionServiceAny : IEquatable<InternalPermissionServiceAny>
{
    /// <summary>
    ...
    public bool Equals(InternalPermissionServiceAny? other)
    {
    ...
    {
        return Equals(obj as InternalPermissionServiceAny);
    }
