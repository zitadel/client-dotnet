...
public class UserServiceAddIDPLinkResponse : IEquatable<UserServiceAddIDPLinkResponse>
{
    ...
    public bool Equals(UserServiceAddIDPLinkResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceAddIDPLinkResponse);
    }
