...
public class BetaProjectServicePaginationRequest : IEquatable<BetaProjectServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(BetaProjectServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as BetaProjectServicePaginationRequest);
    }
