...
/// </summary>
public class BetaWebKeyServiceAny : IEquatable<BetaWebKeyServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaWebKeyServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaWebKeyServiceAny);
    }
