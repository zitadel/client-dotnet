...
public class SessionServiceListQuery : IEquatable<SessionServiceListQuery>
{
    ...
    public bool Equals(SessionServiceListQuery? other)
    {
    ...
    {
        return Equals(obj as SessionServiceListQuery);
    }
