...
public class BetaUserServiceIDPIntent : IEquatable<BetaUserServiceIDPIntent>
{
    ...
    public bool Equals(BetaUserServiceIDPIntent? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceIDPIntent);
    }
