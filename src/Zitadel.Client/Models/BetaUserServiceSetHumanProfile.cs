...
public class BetaUserServiceSetHumanProfile : IEquatable<BetaUserServiceSetHumanProfile>
{
    ...
    public BetaUserServiceGender? Gender { get; set; }

    /// <summary>Value-equality based on all declared fields.</summary>
    public bool Equals(BetaUserServiceSetHumanProfile? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceSetHumanProfile);
    }
