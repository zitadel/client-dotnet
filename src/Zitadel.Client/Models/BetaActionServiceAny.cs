...
/// </summary>
public class BetaActionServiceAny : IEquatable<BetaActionServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaActionServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaActionServiceAny);
    }
