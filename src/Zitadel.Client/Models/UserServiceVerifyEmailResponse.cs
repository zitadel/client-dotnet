...
public class UserServiceVerifyEmailResponse : IEquatable<UserServiceVerifyEmailResponse>
{
    ...
    public bool Equals(UserServiceVerifyEmailResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceVerifyEmailResponse);
    }
