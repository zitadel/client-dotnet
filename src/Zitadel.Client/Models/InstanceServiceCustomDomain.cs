...
public class InstanceServiceCustomDomain : IEquatable<InstanceServiceCustomDomain>
{
    /// <summary>
    ...
    public bool Equals(InstanceServiceCustomDomain? other)
    {
    ...
    {
        return Equals(obj as InstanceServiceCustomDomain);
    }
