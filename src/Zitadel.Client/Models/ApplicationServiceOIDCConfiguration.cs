...
public class ApplicationServiceOIDCConfiguration : IEquatable<ApplicationServiceOIDCConfiguration>
{
    /// <summary>
    ...
    public bool Equals(ApplicationServiceOIDCConfiguration? other)
    {
    ...
    {
        return Equals(obj as ApplicationServiceOIDCConfiguration);
    }
