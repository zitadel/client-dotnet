...
public class UserServiceVerifyPhoneRequest : IEquatable<UserServiceVerifyPhoneRequest>
{
    ...
    public bool Equals(UserServiceVerifyPhoneRequest? other)
    {
    ...
    {
        return Equals(obj as UserServiceVerifyPhoneRequest);
    }
