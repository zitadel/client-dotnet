...
public class SettingsServiceOptions : IEquatable<SettingsServiceOptions>
{
    /// <summary>
    ...
    public SettingsServiceAutoLinkingOption? AutoLinking { get; set; }

    /// <summary>Value-equality based on all declared fields.</summary>
    public bool Equals(SettingsServiceOptions? other)
    {
        return other is not null
            && (ReferenceEquals(this, other)
                || EqualityComparer<bool?>.Default.Equals(this.IsLinkingAllowed, other.IsLinkingAllowed)
                    ...
                    && EqualityComparer<SettingsServiceAutoLinkingOption?>.Default.Equals(this.AutoLinking, other.AutoLinking));
    }

    public override bool Equals(object? obj)
    {
        return Equals(obj as SettingsServiceOptions);
    }
