...
public class UserServiceAddOTPEmailResponse : IEquatable<UserServiceAddOTPEmailResponse>
{
    ...
    public bool Equals(UserServiceAddOTPEmailResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceAddOTPEmailResponse);
    }
