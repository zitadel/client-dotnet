...
/// </summary>
public class BetaSettingsServiceAny : IEquatable<BetaSettingsServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaSettingsServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaSettingsServiceAny);
    }
