...
/// </summary>
public class OrganizationServiceAny : IEquatable<OrganizationServiceAny>
{
    /// <summary>
    ...
    public bool Equals(OrganizationServiceAny? other)
    {
    ...
    {
        return Equals(obj as OrganizationServiceAny);
    }
