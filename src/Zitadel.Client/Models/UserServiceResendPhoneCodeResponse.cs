...
public class UserServiceResendPhoneCodeResponse : IEquatable<UserServiceResendPhoneCodeResponse>
{
    ...
    public bool Equals(UserServiceResendPhoneCodeResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceResendPhoneCodeResponse);
    }
