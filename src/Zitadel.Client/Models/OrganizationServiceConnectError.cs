...
/// </summary>
public class OrganizationServiceConnectError : IEquatable<OrganizationServiceConnectError>
{
    ...
    public List<OrganizationServiceAny>? Details { get; set; }
    ...
    public bool Equals(OrganizationServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as OrganizationServiceConnectError);
    }
