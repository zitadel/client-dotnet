...
/// </summary>
public class IdentityProviderServiceConnectError : IEquatable<IdentityProviderServiceConnectError>
{
    ...
    public List<IdentityProviderServiceAny>? Details { get; set; }
    ...
    public bool Equals(IdentityProviderServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as IdentityProviderServiceConnectError);
    }
