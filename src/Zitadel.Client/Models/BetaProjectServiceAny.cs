...
/// </summary>
public class BetaProjectServiceAny : IEquatable<BetaProjectServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaProjectServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaProjectServiceAny);
    }
