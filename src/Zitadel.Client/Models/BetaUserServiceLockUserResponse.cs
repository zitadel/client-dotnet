...
public class BetaUserServiceLockUserResponse : IEquatable<BetaUserServiceLockUserResponse>
{
    ...
    public bool Equals(BetaUserServiceLockUserResponse? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceLockUserResponse);
    }
