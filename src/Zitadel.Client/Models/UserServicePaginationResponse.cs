...
public class UserServicePaginationResponse : IEquatable<UserServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(UserServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as UserServicePaginationResponse);
    }
