...
public class BetaUserServiceAddOTPSMSResponse : IEquatable<BetaUserServiceAddOTPSMSResponse>
{
    ...
    public bool Equals(BetaUserServiceAddOTPSMSResponse? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceAddOTPSMSResponse);
    }
