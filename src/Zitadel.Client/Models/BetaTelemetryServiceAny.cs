...
/// </summary>
public class BetaTelemetryServiceAny : IEquatable<BetaTelemetryServiceAny>
{
    /// <summary>
    ...
    public bool Equals(BetaTelemetryServiceAny? other)
    {
    ...
    {
        return Equals(obj as BetaTelemetryServiceAny);
    }
