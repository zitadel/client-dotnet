...
/// </summary>
public class BetaSettingsServiceConnectError : IEquatable<BetaSettingsServiceConnectError>
{
    ...
    public List<BetaSettingsServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaSettingsServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaSettingsServiceConnectError);
    }
