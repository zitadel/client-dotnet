...
/// </summary>
public class UserServiceDisplayNameQuery : IEquatable<UserServiceDisplayNameQuery>
{
    ...
    public bool Equals(UserServiceDisplayNameQuery? other)
    {
    ...
    {
        return Equals(obj as UserServiceDisplayNameQuery);
    }
