...
public class BetaAuthorizationServicePaginationRequest : IEquatable<BetaAuthorizationServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(BetaAuthorizationServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as BetaAuthorizationServicePaginationRequest);
    }
