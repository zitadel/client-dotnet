...
public class BetaInternalPermissionServiceProject : IEquatable<BetaInternalPermissionServiceProject>
{
    /// <summary>
    ...
    public bool Equals(BetaInternalPermissionServiceProject? other)
    {
    ...
    {
        return Equals(obj as BetaInternalPermissionServiceProject);
    }
