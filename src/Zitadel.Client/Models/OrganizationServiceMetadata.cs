...
public class OrganizationServiceMetadata : IEquatable<OrganizationServiceMetadata>
{
    /// <summary>
    ...
    public bool Equals(OrganizationServiceMetadata? other)
    {
    ...
    {
        return Equals(obj as OrganizationServiceMetadata);
    }
