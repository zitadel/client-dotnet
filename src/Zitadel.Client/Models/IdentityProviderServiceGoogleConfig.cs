...
public class IdentityProviderServiceGoogleConfig : IEquatable<IdentityProviderServiceGoogleConfig>
{
    /// <summary>
    ...
    public bool Equals(IdentityProviderServiceGoogleConfig? other)
    {
    ...
    {
        return Equals(obj as IdentityProviderServiceGoogleConfig);
    }
