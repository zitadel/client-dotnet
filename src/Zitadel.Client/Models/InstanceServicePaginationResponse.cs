...
public class InstanceServicePaginationResponse : IEquatable<InstanceServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(InstanceServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as InstanceServicePaginationResponse);
    }
