...
/// </summary>
public class ProjectServiceConnectError : IEquatable<ProjectServiceConnectError>
{
    ...
    public List<ProjectServiceAny>? Details { get; set; }
    ...
    public bool Equals(ProjectServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as ProjectServiceConnectError);
    }
