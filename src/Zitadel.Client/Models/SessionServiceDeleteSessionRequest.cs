...
public class SessionServiceDeleteSessionRequest : IEquatable<SessionServiceDeleteSessionRequest>
{
    /// <summary>
    ...
    public bool Equals(SessionServiceDeleteSessionRequest? other)
    {
    ...
    {
        return Equals(obj as SessionServiceDeleteSessionRequest);
    }
