...
/// </summary>
public class BetaUserServiceConnectError : IEquatable<BetaUserServiceConnectError>
{
    ...
    public List<BetaUserServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaUserServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceConnectError);
    }
