        ...
        return other is not null
            && (
                ...
                || EqualityComparer<string?>.Default.Equals(this.UserId, other.UserId)
                    ...
                    && EqualityComparer<BetaUserServiceHumanProfile?>.Default.Equals(
                        this.Profile,
                        other.Profile
                    )
                    && EqualityComparer<BetaUserServiceHumanEmail?>.Default.Equals(
                        this.Email,
                        other.Email
                    )
                    && EqualityComparer<BetaUserServiceHumanPhone?>.Default.Equals(
                        this.Phone,
                        other.Phone
                    )
