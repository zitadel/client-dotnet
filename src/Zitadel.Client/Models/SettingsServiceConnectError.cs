...
/// </summary>
public class SettingsServiceConnectError : IEquatable<SettingsServiceConnectError>
{
    ...
    public List<SettingsServiceAny>? Details { get; set; }
    ...
    public bool Equals(SettingsServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as SettingsServiceConnectError);
    }
