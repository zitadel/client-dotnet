...
/// </summary>
public class IdentityProviderServiceAny : IEquatable<IdentityProviderServiceAny>
{
    /// <summary>
    ...
    public bool Equals(IdentityProviderServiceAny? other)
    {
    ...
    {
        return Equals(obj as IdentityProviderServiceAny);
    }
