...
/// </summary>
public class FeatureServiceConnectError : IEquatable<FeatureServiceConnectError>
{
    ...
    public List<FeatureServiceAny>? Details { get; set; }
    ...
    public bool Equals(FeatureServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as FeatureServiceConnectError);
    }
