...
public class BetaAppServicePaginationResponse : IEquatable<BetaAppServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(BetaAppServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as BetaAppServicePaginationResponse);
    }
