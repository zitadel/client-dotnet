...
public class UserServiceMetadataKeyFilter : IEquatable<UserServiceMetadataKeyFilter>
{
    ...
    public UserServiceTextFilterMethod? Method { get; set; }
    ...
    {
        return Equals(obj as UserServiceMetadataKeyFilter);
    }
