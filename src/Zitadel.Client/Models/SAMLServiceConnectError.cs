...
/// </summary>
public class SAMLServiceConnectError : IEquatable<SAMLServiceConnectError>
{
    ...
    public List<SAMLServiceAny>? Details { get; set; }
    ...
    public bool Equals(SAMLServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as SAMLServiceConnectError);
    }
