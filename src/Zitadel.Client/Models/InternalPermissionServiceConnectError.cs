...
/// </summary>
public class InternalPermissionServiceConnectError
    : IEquatable<InternalPermissionServiceConnectError>
{
    ...
    public List<InternalPermissionServiceAny>? Details { get; set; }
    ...
    public bool Equals(InternalPermissionServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as InternalPermissionServiceConnectError);
    }
