...
/// </summary>
public class InternalPermissionServiceConnectError : IEquatable<InternalPermissionServiceConnectError>
{
        ...
        return other is not null
            && (ReferenceEquals(this, other)
                || EqualityComparer<CodeEnum?>.Default.Equals(this.Code, other.Code)
                    ...
                    && EqualityComparer<List<InternalPermissionServiceAny>?>.Default.Equals(this.Details, other.Details)
