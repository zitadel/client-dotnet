...
public class UserServiceVerifyPhoneResponse : IEquatable<UserServiceVerifyPhoneResponse>
{
    ...
    public bool Equals(UserServiceVerifyPhoneResponse? other)
    {
    ...
    {
        return Equals(obj as UserServiceVerifyPhoneResponse);
    }
