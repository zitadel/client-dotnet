...
public class BetaUserServiceListQuery : IEquatable<BetaUserServiceListQuery>
{
    ...
    public bool Equals(BetaUserServiceListQuery? other)
    {
    ...
    {
        return Equals(obj as BetaUserServiceListQuery);
    }
