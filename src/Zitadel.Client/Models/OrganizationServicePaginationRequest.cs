...
public class OrganizationServicePaginationRequest : IEquatable<OrganizationServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(OrganizationServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as OrganizationServicePaginationRequest);
    }
