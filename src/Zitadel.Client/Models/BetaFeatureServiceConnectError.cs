...
/// </summary>
public class BetaFeatureServiceConnectError : IEquatable<BetaFeatureServiceConnectError>
{
    ...
    public List<BetaFeatureServiceAny>? Details { get; set; }
    ...
    public bool Equals(BetaFeatureServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as BetaFeatureServiceConnectError);
    }
