...
public class ActionServiceRESTWebhook : IEquatable<ActionServiceRESTWebhook>
{
    /// <summary>
    ...
    public bool Equals(ActionServiceRESTWebhook? other)
    {
    ...
    {
        return Equals(obj as ActionServiceRESTWebhook);
    }
