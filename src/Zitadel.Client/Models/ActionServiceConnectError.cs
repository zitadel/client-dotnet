...
/// </summary>
public class ActionServiceConnectError : IEquatable<ActionServiceConnectError>
{
    ...
    public List<ActionServiceAny>? Details { get; set; }
    ...
    public bool Equals(ActionServiceConnectError? other)
    {
    ...
    {
        return Equals(obj as ActionServiceConnectError);
    }
