...
public class AuthorizationServicePaginationResponse : IEquatable<AuthorizationServicePaginationResponse>
{
    /// <summary>
    ...
    public bool Equals(AuthorizationServicePaginationResponse? other)
    {
    ...
    {
        return Equals(obj as AuthorizationServicePaginationResponse);
    }
