...
public class SessionServiceCheckOTP : IEquatable<SessionServiceCheckOTP>
{
    /// <summary>
    ...
    public bool Equals(SessionServiceCheckOTP? other)
    {
    ...
    {
        return Equals(obj as SessionServiceCheckOTP);
    }
