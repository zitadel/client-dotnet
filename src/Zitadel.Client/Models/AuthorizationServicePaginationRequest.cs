...
public class AuthorizationServicePaginationRequest : IEquatable<AuthorizationServicePaginationRequest>
{
    /// <summary>
    ...
    public bool Equals(AuthorizationServicePaginationRequest? other)
    {
    ...
    {
        return Equals(obj as AuthorizationServicePaginationRequest);
    }
