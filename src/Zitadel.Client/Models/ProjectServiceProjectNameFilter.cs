...
public class ProjectServiceProjectNameFilter : IEquatable<ProjectServiceProjectNameFilter>
{
    /// <summary>
    ...
    public bool Equals(ProjectServiceProjectNameFilter? other)
    {
    ...
    {
        return Equals(obj as ProjectServiceProjectNameFilter);
    }
