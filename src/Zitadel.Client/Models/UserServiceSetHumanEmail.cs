...
public class UserServiceSetHumanEmail : IEquatable<UserServiceSetHumanEmail>
{
    ...
    public bool Equals(UserServiceSetHumanEmail? other)
    {
    ...
    {
        return Equals(obj as UserServiceSetHumanEmail);
    }
