...
public class ValueSerializerTest
{
    ...
    public void path_array_item_with_reserved_char_is_percent_encoded()
    {
        ...
        Assert.Equal("a%2Fb,c", ValueSerializer.SerializeStyled("name", items, "path", "array", null, "simple", false));
        Assert.Equal(".a%2Fb.c", ValueSerializer.SerializeStyled("name", items, "path", "array", null, "label", true));
        Assert.Equal(";name=a%2Fb,c", ValueSerializer.SerializeStyled("name", items, "path", "array", null, "matrix", false));
    }
    ...
    public void path_param_is_encoded_exactly_once_not_double_encoded()
    {
        ...
        string once = (string)ValueSerializer.SerializeStyled(
            "name", "a/b c", "path", "string", null, "simple", false)!;
